...
public enum HTTPError {
    ...
    Request_Header_Fields_Too_Large(431), Login_Timeout(440), No_Response(444), Retry_With(449),
    Blocked_by_Windows_Parental_Controls(450), Unavailable_For_Legal_Reasons(451), Client_Closed_Request(499);
